...
**Dependencies:** Imports from `common` for `SourceLocation`, `Diagnostic`, `InternId`, `SourceMap`.
...
| File | Responsibility |
|---|---|
| `mod.rs` | Re-export all common types: `SourceLocation`, `Diagnostic`, `InternId`, `Arena` |
...
| `frontend::lexer` | `common` | `SourceLocation`, `Diagnostic`, `InternId` |
| `frontend::preprocessor` | `frontend::lexer`, `common` | `Token`, `Vec<Token>`, `SourceMap` |
| `frontend::parser` | `frontend::lexer`, `common` | `Token`, `Vec<Token>`, AST node types |
